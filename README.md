...
contract PAYOOSWAP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xE62eA7Fb795c7B52970E3A1391Db41b2BbeCFAd5); // Marketing Address
    address payable public charityAddress = payable(0xE62eA7Fb795c7B52970E3A1391Db41b2BbeCFAd5); // Charity/Dev Address
    ...
    uint256 private _tTotal = 10000000000000000 * 10**18; // 10 Qud
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "PAYOOSWAP Coin";
    string private _symbol = "PYSWAP";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropEth =   2563000000000000; //0.002563 BNB Airdrop fee
    uint256 private _airdropToken = 30000000000000000000000000; // 30,000,000; token will be given on airdrop
